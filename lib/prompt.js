...
RULE 9 — DAY CITY FIELD (MANDATORY):
  Every day object MUST include a "city" field: the primary city for that day (e.g. "Rome", "Florence").
  This field drives hotel matching and the SOS emergency screen. Single city name, no country suffix.
...
"city" = primary city name for that day (e.g. "Paris", "Lyon"). Required for hotel matching.
