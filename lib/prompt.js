...
IMPORTANT — hotels[] and budget[] must NOT be empty:
- hotels[]: Include AT LEAST one hotel per city. Every city that has an overnight stay must have a hotel entry. Hotels MUST include checkin/checkout dates.
- budget[]: Include AT LEAST 10 budget items covering: flights (if applicable), accommodation per city, meals, activities, local transport, and misc. NEVER return empty arrays.
