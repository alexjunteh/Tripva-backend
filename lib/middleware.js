const ALLOWED_ORIGIN = process.env.ALLOWED_ORIGIN || 'https://futuriztaos.github.io';
const RATE_LIMIT = 10;
...
export function applyCors(req, res) {
  ...
  if (origin === ALLOWED_ORIGIN || isDev) {
    res.setHeader('Access-Control-Allow-Origin', isDev && !origin ? '*' : (origin || ALLOWED_ORIGIN));
  }
