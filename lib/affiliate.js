...
// ── AFFILIATE IDS ─────────────────────────────────────────────────────────────
const AFFILIATE_IDS = {
  booking:      process.env.TRIPVA_BOOKING_ID      || 'TRIPVA_BOOKING_ID',
  trainline:    process.env.TRIPVA_TRAINLINE_ID    || 'TRIPVA_TRAINLINE_ID',
  getyourguide: process.env.TRIPVA_GYG_ID          || 'TRIPVA_GYG_ID',
  rentalcars:   process.env.TRIPVA_RENTALCARS_ID || process.env.RENTALCARS_AFFILIATE_ID || 'TRIPVA_RENTALCARS_ID',
};
